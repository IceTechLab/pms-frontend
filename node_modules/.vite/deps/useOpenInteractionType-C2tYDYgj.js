...
import { c as useMergedRefs, i as NOOP, l as useRefWithInit, r as EMPTY_OBJECT, s as isReactVersionAtLeast, t as useRenderElement } from "./useRenderElement-gqJcEQLj.js";
import { n as useStableCallback, t as useIsoLayoutEffect } from "./useIsoLayoutEffect-CrT9ErPw.js";
import { a as endingStyle$1, c as AnimationFrame, l as useAnimationFrame, n as transitionStatusMapping, o as startingStyle$1, r as useOpenChangeComplete, s as resolveRef, t as useTransitionStatus } from "./useTransitionStatus-CuL25ySt.js";
import { n as useTimeout, t as Timeout } from "./useTimeout-BN7Bovl1.js";
import { _ as isShadowRoot, f as isElement, g as isOverflowElement, h as isNode, l as getParentNode, m as isLastTraversableNode, n as getComputedStyle, o as getNodeName, p as isHTMLElement, u as getWindow } from "./error-B9KXeeSc.js";
import { i as ownerDocument, n as contains, r as getTarget, t as activeElement } from "./shadowDom-BWymEToc.js";
import { t as visuallyHidden } from "./visuallyHidden-YCfFQkZl.js";
import { _ as triggerPress, a as escapeKey, b as useId, f as none, o as focusOut, p as outsidePress, t as createChangeEventDetails } from "./createBaseUIEventDetails-hQ4_Dc95.js";
import { t as useValueChanged } from "./useValueChanged-B4mTx6SM.js";
import { d as require_shim, h as isElementVisible } from "./inertValue-B6V2r8aq.js";
//#region ../node_modules/@base-ui/react/utils/CommonPopupDataAttributes.mjs
...
*/
var endingStyle = endingStyle$1;
/**
* Present when the anchor is hidden.
*/
var anchorHidden = "data-anchor-hidden";
//#endregion
//#region ../node_modules/@base-ui/react/utils/CommonTriggerDataAttributes.mjs
/**
* Present when the popup is open.
*/
...
var POPUP_OPEN_HOOK = { [open]: "" };
var POPUP_CLOSED_HOOK = { [closed]: "" };
...
//#endregion
export { matchesFocusVisible as $, useFloatingTree as A, getNextTabbable as B, useDismiss as C, FloatingTree as D, FloatingNode as E, DROPDOWN_COLLISION_AVOIDANCE as F, useValueAsRef as G, getTabbableBeforeElement as H, POPUP_COLLISION_AVOIDANCE as I, getFloatingFocusElement as J, mergeCleanups as K, enqueueFocus as L, FloatingPortal as M, CLICK_TRIGGER_IDENTIFIER as N, useFloatingNodeId as O, DISABLED_TRANSITIONS_STYLE as P, isTypeableElement as Q, createAttribute as R, fastComponentRef as S, FloatingFocusManager as T, isOutsideEvent as U, getTabbableAfterElement as V, FocusGuard as W, isTargetInsideEnabledTrigger as X, isInteractiveElement as Y, isTypeableCombobox as Z, useTriggerRegistration as _, pressed as _t, PopupTriggerMap as a, isVirtualClick as at, ReactStore as b, open as bt, attachPreventUnmountOnClose as c, jsdom as ct, useImplicitActiveTrigger as d, mac as dt, ARROW_DOWN as et, useOpenStateTransitions as f, popupStateMapping as ft, useTriggerDataForwarding as g, popupOpen$1 as gt, usePopupRootSync as h, triggerOpenStateMapping as ht, InternalBackdrop as i, isMouseLikePointerType as it, FloatingTreeStore as j, useFloatingParentNodeId as k, createDefaultInitialFocus as l, voiceOver as lt, usePopupRootStore as m, pressableTriggerOpenStateMapping as mt, useOpenMethodTriggerProps as n, ARROW_RIGHT as nt, FOCUSABLE_POPUP_PROPS as o, isVirtualPointerEvent as ot, usePopupInteractionProps as p, popupTransitionStateMapping as pt, addEventListener as q, useScrollLock as r, ARROW_UP as rt, PopupHandleAttachment as s, stopEvent as st, useOpenInteractionType as t, ARROW_LEFT as tt, createPopupOpenState as u, webkit as ut, useSyncedFloatingRootContext as v, closed as vt, useClick as w, fastComponent as x, startingStyle as xt, FloatingRootStore as y, endingStyle as yt, getNodeChildren as z };
